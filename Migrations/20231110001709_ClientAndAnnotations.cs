    ...
    public partial class ClientAndAnnotations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 11, 9, 19, 17, 9, 338, DateTimeKind.Local).AddTicks(8005), 1 },
                    { 2, 2, new DateTime(2023, 11, 9, 19, 17, 9, 338, DateTimeKind.Local).AddTicks(8053), 7 },
                    { 3, 1, new DateTime(2023, 11, 9, 19, 17, 9, 338, DateTimeKind.Local).AddTicks(8056), 5 }
                });
