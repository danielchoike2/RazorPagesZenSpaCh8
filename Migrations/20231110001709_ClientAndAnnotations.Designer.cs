...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20231110001709_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2023, 11, 9, 19, 17, 9, 338, DateTimeKind.Local).AddTicks(8005),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2023, 11, 9, 19, 17, 9, 338, DateTimeKind.Local).AddTicks(8053),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2023, 11, 9, 19, 17, 9, 338, DateTimeKind.Local).AddTicks(8056),
                            ServicesID = 5
                        });
                });
